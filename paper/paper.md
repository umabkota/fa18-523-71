...
Interactions between digital mediums require special architecture and there are many architectures for IoT. The most common IoT Ecosystem architecture is as shown in  \ref{fig1}. It consists of seven different layers [@fa18-523-59-www-iot-architecture].  

  

![\label{fig1}](https://github.com/cloudmesh-community/fa18-523-71/blob/master/paper/images/IoT%20Architecture.png)  
...
![\label{fig2}](https://github.com/cloudmesh-community/fa18-523-71/blob/master/paper/images/IoT%20and%20big%20data%20platform.jpg)  
...
Big data helps businesses in coming up with inferences, insights and actionable recommendations by analyzing the unstructured or semi-structured data. Billions of devices are expected to be connected to the internet and hence for the functionalities of these devices to be held, data is needed.  IoT will be a major data source for the data that is to be analyzed by companies for growth and effective decision making with the nexus of big data and the IOT data from the connected devices making it cheaper and faster. The process of IoT with Big Data is seen in \ref{fig3}  [@fa18-523-59-www-iot-iotandbigdata].  

  

  ![\label{fig3}](https://github.com/cloudmesh-community/fa18-523-71/blob/master/paper/images/IoT%20and%20Big%20data%20Analysis.jpg)  
...
The Internet of Things and Big Data coming together plays and important role in commercial, industrial and other applications to offer better data sights and inferences. Some of the most common application are shown in the figure \ref{fig4} [@fa18-523-59-www-iot-intro].  

  

  ![\label{fig4}](https://github.com/cloudmesh-community/fa18-523-71/blob/master/paper/images/IoT%20application.png)  
